...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This function computes the approximate molecular absorption coefficients in the sub-THz band using an approximation that is valid in the frequency range: [100-450] GHz
...
mu = (p.rel_humidity/100)*(Pw/pressurehPa);
